            ...
            <div className="holder">
                <div className="frame">
                    ...
                    <div className="images-holder">
                        ...
                        <ImageButton name='NotCapsuleRecognition' image={images.NotCapsuleRecognition} label="Wrong Capsule Recognition" changeWindow={this.props.changeWindow} addLog={this.props.addLog} title="Kind of problem"/>
